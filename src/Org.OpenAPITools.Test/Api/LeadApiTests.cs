...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public class LeadApiTests : IDisposable
    {
        ...
        public void ListLeadsApiTest()
        {
            ...
            //int? page = null;
            //int? pageSize = null;
            //var response = instance.ListLeadsApi(status, source, search, page, pageSize);
            //Assert.IsType<List<Lead>>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void UpdateLeadApiTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid leadId = null;
            //LeadUpdate leadUpdate = null;
            //var response = instance.UpdateLeadApi(leadId, leadUpdate);
