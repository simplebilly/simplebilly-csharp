...
{
    /// <summary>
    ///  Class for testing ZugferdApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class ZugferdApiTests : IDisposable
    {
        private ZugferdApi instance;

        public ZugferdApiTests()
        {
            instance = new ZugferdApi();
        }
        ...
        /// <summary>
        /// Test an instance of ZugferdApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' ZugferdApi
            //Assert.IsType<ZugferdApi>(instance);
        }

        /// <summary>
        /// Test GenerateZugferdApi
        /// </summary>
        [Fact]
        public void GenerateZugferdApiTest()
        {
            ...
            //instance.GenerateZugferdApi(id, supplierName, supplierStreet, supplierCity, supplierZip, supplierCountry, supplierVatId);
        }
    }
}
