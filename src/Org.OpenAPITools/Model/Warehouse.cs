...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Warehouse : IValidatableObject
    {
        ...
        public Warehouse(string addressCity = default, CountryCode? addressCountry = default, string addressStreet = default, string addressZip = default, Object binLocations = default, string code = default, bool isActive = default, bool isDefault = default, string name = default, string notes = default)
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for Warehouse and cannot be null");
            }
            this.Code = code;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Warehouse and cannot be null");
            }
            this.Name = name;
