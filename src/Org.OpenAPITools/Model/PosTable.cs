...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PosTable")]
    public partial class PosTable : IValidatableObject
    {
        ...
        public PosTable(string currentOrderNumber = default, string name = default, PosTableStatus? status = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PosTable and cannot be null");
            }
            this.Name = name;
