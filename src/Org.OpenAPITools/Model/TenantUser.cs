...
namespace Org.OpenAPITools.Model
{
    ...
    /// TenantUser
    /// </summary>
    [DataContract(Name = "TenantUser")]
    public partial class TenantUser : IValidatableObject
    {
        /// <summary>
        ...
        public TenantUser(string email = default, bool emailVerified = default, bool isActive = default, DateTime joinedAt = default, DateTime? lastLogin = default, string name = default, List<string> permissions = default, string role = default, Guid userId = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for TenantUser and cannot be null");
            }
            this.Email = email;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TenantUser and cannot be null");
            }
            this.Name = name;
            // to ensure "permissions" is required (not null)
            if (permissions == null)
            {
                throw new ArgumentNullException("permissions is a required property for TenantUser and cannot be null");
            }
            this.Permissions = permissions;
            // to ensure "role" is required (not null)
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for TenantUser and cannot be null");
            }
            this.Role = role;
            this.UserId = userId;
