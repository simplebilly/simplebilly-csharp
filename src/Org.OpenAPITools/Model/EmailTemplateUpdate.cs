...
namespace Org.OpenAPITools.Model
{
    ...
    /// EmailTemplateUpdate
    /// </summary>
    [DataContract(Name = "EmailTemplateUpdate")]
    public partial class EmailTemplateUpdate : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="body">E-mail body with optional placeholders..</param>
        /// <param name="name">Human-readable template name, e.g. \&quot;Follow-up after quote\&quot;..</param>
        /// <param name="status">One of: active | inactive.</param>
        /// <param name="subject">E-mail subject line with optional placeholders..</param>
        /// <param name="variables">Placeholders used by this template, e.g. &#x60;[\&quot;contact.first_name\&quot;]&#x60;..</param>
        public EmailTemplateUpdate(string body = default, string name = default, EmailTemplateStatus? status = default, string subject = default, Object variables = default)
        {
            this.Body = body;
            this.Name = name;
            this.Status = status;
