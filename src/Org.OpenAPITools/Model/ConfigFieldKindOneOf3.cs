...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConfigFieldKind_oneOf_3")]
    public partial class ConfigFieldKindOneOf3 : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigFieldKindOneOf3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConfigFieldKindOneOf3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigFieldKindOneOf3" /> class.
        /// </summary>
        /// <param name="options">options (required).</param>
        /// <param name="type">type (required).</param>
        public ConfigFieldKindOneOf3(List<string> options = default, TypeEnum type = default)
        {
            // to ensure "options" is required (not null)
            if (options == null)
            {
                throw new ArgumentNullException("options is a required property for ConfigFieldKindOneOf3 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfigFieldKindOneOf3 {\n");
