...
namespace Org.OpenAPITools.Model
{
    ...
    /// PurchaseOrderUpdate
    /// </summary>
    [DataContract(Name = "PurchaseOrderUpdate")]
    public partial class PurchaseOrderUpdate : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderUpdate" /> class.
        /// </summary>
        ...
        /// <param name="status">One of: draft | ordered | partially_received | received | cancelled.</param>
        ...
        public PurchaseOrderUpdate(string currency = default, Object deliveryAddress = default, DateOnly? expectedDeliveryDate = default, Object lineItems = default, string notes = default, DateOnly? orderDate = default, string poNumber = default, PurchaseOrderStatus? status = default, string supplierContactId = default, string supplierName = default, string totalGrossAmount = default, string totalNetAmount = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "poNumber", EmitDefaultValue = true)]
