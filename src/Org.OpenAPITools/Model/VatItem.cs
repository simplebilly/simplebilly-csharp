...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VatItem : IValidatableObject
    {
        ...
        public VatItem(string netAmount = default, string taxAmount = default, string taxRate = default)
        {
            // to ensure "netAmount" is required (not null)
            if (netAmount == null)
            {
                throw new ArgumentNullException("netAmount is a required property for VatItem and cannot be null");
            }
            this.NetAmount = netAmount;
            // to ensure "taxAmount" is required (not null)
            if (taxAmount == null)
            {
                throw new ArgumentNullException("taxAmount is a required property for VatItem and cannot be null");
            }
            this.TaxAmount = taxAmount;
            // to ensure "taxRate" is required (not null)
            if (taxRate == null)
            {
                throw new ArgumentNullException("taxRate is a required property for VatItem and cannot be null");
            }
