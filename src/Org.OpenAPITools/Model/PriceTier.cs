...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PriceTier : IValidatableObject
    {
        /// <summary>
        ...
        public PriceTier(string customerGroupId = default, long minQuantity = default, Guid productId = default, string unitPrice = default)
        {
            this.ProductId = productId;
            // to ensure "unitPrice" is required (not null)
            if (unitPrice == null)
            {
                throw new ArgumentNullException("unitPrice is a required property for PriceTier and cannot be null");
            }
