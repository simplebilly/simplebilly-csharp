...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Coupon : IValidatableObject
    {
        ...
        public Coupon(string code = default, string description = default, DiscountType discountType = default, string discountValue = default, DateTime? expiresAt = default, bool isActive = default, bool isCombineable = default, string maxDiscountAmount = default, int? maxUses = default, int? maxUsesPerCustomer = default, string minOrderAmount = default, Object productIds = default, DateTime? startsAt = default)
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for Coupon and cannot be null");
            }
            this.Code = code;
            ...
            {
                throw new ArgumentNullException("discountValue is a required property for Coupon and cannot be null");
            }
