...
namespace Org.OpenAPITools.Model
{
    ...
    /// ImportTestResponse
    /// </summary>
    [DataContract(Name = "ImportTestResponse")]
    public partial class ImportTestResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportTestResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImportTestResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportTestResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="ok">ok (required).</param>
        public ImportTestResponse(string error = default, bool ok = default)
        {
            this.Ok = ok;
            this.Error = error;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportTestResponse {\n");
