...
namespace Org.OpenAPITools.Model
{
    ...
    /// SupportTicket
    /// </summary>
    [DataContract(Name = "SupportTicket")]
    public partial class SupportTicket : IValidatableObject
    {
        ...
        /// <param name="firstMessageAt">firstMessageAt (required).</param>
        /// <param name="lastMessageAt">lastMessageAt (required).</param>
        ...
        public SupportTicket(Guid? assignedTo = default, Guid? channelId = default, SupportChannelType? channelType = default, DateTime? closedAt = default, DateTime createdAt = default, string customerEmail = default, string customerId = default, string customerName = default, string externalId = default, DateTime firstMessageAt = default, DateTime lastMessageAt = default, Guid? leadId = default, int messageCount = default, string orderRef = default, TicketPriority priority = default, string resolution = default, SupportTicketStatus status = default, string subject = default, Object tags = default, Guid tenantId = default, DateTime? updatedAt = default)
        {
            ...
            if (subject == null)
            {
                throw new ArgumentNullException("subject is a required property for SupportTicket and cannot be null");
            }
            this.Subject = subject;
            // to ensure "tags" is required (not null)
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for SupportTicket and cannot be null");
            }
            this.Tags = tags;
        ...
        /// </summary>
        [DataMember(Name = "firstMessageAt", IsRequired = true, EmitDefaultValue = true)]
        public DateTime FirstMessageAt { get; set; }

        /// <summary>
        /// Gets or Sets LastMessageAt
        /// </summary>
        [DataMember(Name = "lastMessageAt", IsRequired = true, EmitDefaultValue = true)]
