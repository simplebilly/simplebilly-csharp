...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Team : IValidatableObject
    {
        ...
        public Team(DateTime createdAt = default, string description = default, Guid id = default, string name = default, Guid? parentTeamId = default, Guid tenantId = default, DateTime updatedAt = default)
        {
