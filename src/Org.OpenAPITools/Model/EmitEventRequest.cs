...
namespace Org.OpenAPITools.Model
{
    ...
    /// EmitEventRequest
    /// </summary>
    [DataContract(Name = "EmitEventRequest")]
    public partial class EmitEventRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmitEventRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmitEventRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmitEventRequest" /> class.
        /// </summary>
        /// <param name="eventType">eventType (required).</param>
        /// <param name="payload">payload.</param>
        public EmitEventRequest(string eventType = default, Object payload = default)
        {
            // to ensure "eventType" is required (not null)
            if (eventType == null)
            {
                throw new ArgumentNullException("eventType is a required property for EmitEventRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmitEventRequest {\n");
