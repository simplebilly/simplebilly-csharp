...
namespace Org.OpenAPITools.Model
{
    ...
    /// TotpEnableRequest
    /// </summary>
    [DataContract(Name = "TotpEnableRequest")]
    public partial class TotpEnableRequest : IValidatableObject
    {
        ...
        public TotpEnableRequest(string code = default)
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for TotpEnableRequest and cannot be null");
            }
            this.Code = code;
        }
