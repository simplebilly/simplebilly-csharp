...
namespace Org.OpenAPITools.Model
{
    ...
    /// MagicLinkRequest
    /// </summary>
    [DataContract(Name = "MagicLinkRequest")]
    public partial class MagicLinkRequest : IValidatableObject
    {
        ...
        protected MagicLinkRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MagicLinkRequest" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        public MagicLinkRequest(string email = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for MagicLinkRequest and cannot be null");
            }
            this.Email = email;
        }
