...
namespace Org.OpenAPITools.Model
{
    ...
    /// ImportStartResponse
    /// </summary>
    [DataContract(Name = "ImportStartResponse")]
    public partial class ImportStartResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportStartResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImportStartResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportStartResponse" /> class.
        /// </summary>
        /// <param name="jobId">jobId (required).</param>
        public ImportStartResponse(string jobId = default)
        {
            // to ensure "jobId" is required (not null)
            if (jobId == null)
            {
                throw new ArgumentNullException("jobId is a required property for ImportStartResponse and cannot be null");
            }
            this.JobId = jobId;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportStartResponse {\n");
