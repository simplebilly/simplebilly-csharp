...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ResetPasswordRequest : IValidatableObject
    {
        ...
        public ResetPasswordRequest(string newPassword = default, string token = default)
        {
            ...
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for ResetPasswordRequest and cannot be null");
            }
            this.Token = token;
        }
