...
namespace Org.OpenAPITools.Model
{
    ...
    /// CouponUpdate
    /// </summary>
    [DataContract(Name = "CouponUpdate")]
    public partial class CouponUpdate : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponUpdate" /> class.
        /// </summary>
        ...
        public CouponUpdate(string code = default, string description = default, DiscountType? discountType = default, string discountValue = default, DateTime? expiresAt = default, bool? isActive = default, bool? isCombineable = default, string maxDiscountAmount = default, int? maxUses = default, int? maxUsesPerCustomer = default, string minOrderAmount = default, Object productIds = default, DateTime? startsAt = default)
        {
            this.Code = code;
        ...
        /// </summary>
        [DataMember(Name = "discountValue", EmitDefaultValue = true)]
