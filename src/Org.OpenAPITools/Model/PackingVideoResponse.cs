...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackingVideoResponse")]
    public partial class PackingVideoResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackingVideoResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackingVideoResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackingVideoResponse" /> class.
        /// </summary>
        ...
        public PackingVideoResponse(string message = default, string recordingUrl = default, bool success = default)
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for PackingVideoResponse and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "recording_url", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PackingVideoResponse {\n");
