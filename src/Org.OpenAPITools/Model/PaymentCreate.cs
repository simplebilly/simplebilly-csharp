...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentCreate : IValidatableObject
    {
        ...
        public PaymentCreate(string amount = default, Object attachment = default, string currency = default, string customerId = default, string description = default, Object metadata = default, PaymentMethod? method = default, DateTime paymentDate = default, string reference = default)
        {
            this.Amount = amount;
