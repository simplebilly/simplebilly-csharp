...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApiResponse_SubscriptionOverview_data")]
    public partial class ApiResponseSubscriptionOverviewData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseSubscriptionOverviewData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiResponseSubscriptionOverviewData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseSubscriptionOverviewData" /> class.
        /// </summary>
        ...
        public ApiResponseSubscriptionOverviewData(DateTime? currentPeriodEnd = default, PlanFeatures features = default, bool isTrialing = default, PlanLimits limits = default, string manageUrl = default, string plan = default, string planName = default, double priceEur = default, int? quantity = default, string status = default, string subscriptionId = default, DateTime? trialEndsAt = default, UsageSnapshot usage = default)
        {
            ...
            if (limits == null)
            {
                throw new ArgumentNullException("limits is a required property for ApiResponseSubscriptionOverviewData and cannot be null");
            }
            this.Limits = limits;
            // to ensure "plan" is required (not null)
            if (plan == null)
            {
                throw new ArgumentNullException("plan is a required property for ApiResponseSubscriptionOverviewData and cannot be null");
            }
            this.Plan = plan;
            // to ensure "planName" is required (not null)
            if (planName == null)
            {
                throw new ArgumentNullException("planName is a required property for ApiResponseSubscriptionOverviewData and cannot be null");
            }
            ...
            if (usage == null)
            {
                throw new ArgumentNullException("usage is a required property for ApiResponseSubscriptionOverviewData and cannot be null");
            }
            this.Usage = usage;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseSubscriptionOverviewData {\n");
