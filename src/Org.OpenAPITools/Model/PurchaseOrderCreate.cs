...
namespace Org.OpenAPITools.Model
{
    ...
    /// PurchaseOrderCreate
    /// </summary>
    [DataContract(Name = "PurchaseOrderCreate")]
    public partial class PurchaseOrderCreate : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PurchaseOrderCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderCreate" /> class.
        /// </summary>
        ...
        public PurchaseOrderCreate(string currency = default, Object deliveryAddress = default, DateOnly? expectedDeliveryDate = default, Object lineItems = default, string notes = default, DateOnly orderDate = default, string poNumber = default, PurchaseOrderStatus status = default, string supplierContactId = default, string supplierName = default, string totalGrossAmount = default, string totalNetAmount = default)
        {
            this.OrderDate = orderDate;
            // to ensure "poNumber" is required (not null)
            if (poNumber == null)
            {
                throw new ArgumentNullException("poNumber is a required property for PurchaseOrderCreate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseOrderCreate {\n");
