...
namespace Org.OpenAPITools.Model
{
    ...
    /// ProductStock
    /// </summary>
    [DataContract(Name = "ProductStock")]
    public partial class ProductStock : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductStock" /> class.
        /// </summary>
        ...
        public ProductStock(string name = default, Guid productId = default, string sku = default, long? stockQuantity = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ProductStock and cannot be null");
            }
            this.Name = name;
            ...
            if (sku == null)
            {
                throw new ArgumentNullException("sku is a required property for ProductStock and cannot be null");
            }
            this.Sku = sku;
        ...
        /// </summary>
        [DataMember(Name = "stock_quantity", EmitDefaultValue = true)]
