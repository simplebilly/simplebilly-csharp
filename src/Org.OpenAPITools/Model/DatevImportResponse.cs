...
namespace Org.OpenAPITools.Model
{
    ...
    /// DatevImportResponse
    /// </summary>
    [DataContract(Name = "DatevImportResponse")]
    public partial class DatevImportResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DatevImportResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DatevImportResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DatevImportResponse" /> class.
        /// </summary>
        ...
        public DatevImportResponse(int count = default, string filename = default, List<DatevImportRow> rows = default)
        {
            this.Count = count;
            // to ensure "filename" is required (not null)
            if (filename == null)
            {
                throw new ArgumentNullException("filename is a required property for DatevImportResponse and cannot be null");
            }
            this.Filename = filename;
            // to ensure "rows" is required (not null)
            if (rows == null)
            {
                throw new ArgumentNullException("rows is a required property for DatevImportResponse and cannot be null");
            }
            this.Rows = rows;
        }
        ...
        public List<DatevImportRow> Rows { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DatevImportResponse {\n");
