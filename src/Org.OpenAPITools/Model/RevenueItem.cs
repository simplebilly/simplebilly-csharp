...
namespace Org.OpenAPITools.Model
{
    ...
    /// RevenueItem
    /// </summary>
    [DataContract(Name = "RevenueItem")]
    public partial class RevenueItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RevenueItem" /> class.
        /// </summary>
        ...
        public RevenueItem(string amount = default, string category = default, double percentage = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for RevenueItem and cannot be null");
            }
            this.Amount = amount;
            // to ensure "category" is required (not null)
            if (category == null)
            {
                throw new ArgumentNullException("category is a required property for RevenueItem and cannot be null");
            }
