...
namespace Org.OpenAPITools.Model
{
    ...
    /// PluginErrorOneOf5
    /// </summary>
    [DataContract(Name = "PluginError_oneOf_5")]
    public partial class PluginErrorOneOf5 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PluginErrorOneOf5" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PluginErrorOneOf5() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PluginErrorOneOf5" /> class.
        /// </summary>
        /// <param name="validationError">validationError (required).</param>
        public PluginErrorOneOf5(List<Object> validationError = default)
        {
            // to ensure "validationError" is required (not null)
            if (validationError == null)
            {
                throw new ArgumentNullException("validationError is a required property for PluginErrorOneOf5 and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "ValidationError", IsRequired = true, EmitDefaultValue = true)]
        public List<Object> ValidationError { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PluginErrorOneOf5 {\n");
