...
namespace Org.OpenAPITools.Model
{
    ...
    /// PnLItem
    /// </summary>
    [DataContract(Name = "PnLItem")]
    public partial class PnLItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PnLItem" /> class.
        /// </summary>
        ...
        public PnLItem(string account = default, string accountName = default, string amount = default)
        {
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for PnLItem and cannot be null");
            }
            this.Account = account;
            // to ensure "accountName" is required (not null)
            if (accountName == null)
            {
                throw new ArgumentNullException("accountName is a required property for PnLItem and cannot be null");
            }
            this.AccountName = accountName;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for PnLItem and cannot be null");
            }
            this.Amount = amount;
        }
