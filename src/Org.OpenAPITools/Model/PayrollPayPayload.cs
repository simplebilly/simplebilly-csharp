...
namespace Org.OpenAPITools.Model
{
    ...
    /// PayrollPayPayload
    /// </summary>
    [DataContract(Name = "PayrollPayPayload")]
    public partial class PayrollPayPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayrollPayPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayrollPayPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayrollPayPayload" /> class.
        /// </summary>
        /// <param name="paymentDate">paymentDate (required).</param>
        public PayrollPayPayload(DateOnly paymentDate = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayrollPayPayload {\n");
