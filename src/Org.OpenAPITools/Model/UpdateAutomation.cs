...
namespace Org.OpenAPITools.Model
{
    ...
    /// UpdateAutomation
    /// </summary>
    [DataContract(Name = "UpdateAutomation")]
    public partial class UpdateAutomation : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAutomation" /> class.
        /// </summary>
        /// <param name="config">config.</param>
        /// <param name="enabled">enabled.</param>
        public UpdateAutomation(Object config = default, bool? enabled = default)
        {
            this.Config = config;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAutomation {\n");
