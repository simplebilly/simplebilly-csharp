...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Shareholder : IValidatableObject
    {
        /// <summary>
        ...
        public Shareholder(string address = default, DateOnly? birthDate = default, string email = default, string firstName = default, string lastName = default, string shareNumber = default, string shares = default)
        {
