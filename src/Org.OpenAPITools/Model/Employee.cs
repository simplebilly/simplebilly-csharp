...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Employee : IValidatableObject
    {
        ...
        public Employee(string address = default, Guid? backupEmployeeId = default, string bic = default, string city = default, CountryCode? country = default, DateTime createdAt = default, DateOnly? dateOfBirth = default, DateTime? deletedAt = default, Guid departmentId = default, string email = default, string firstName = default, Gender? gender = default, DateOnly? hireDate = default, string hourlyCost = default, string iban = default, Guid id = default, string jobTitle = default, DateTime? lastLogin = default, string lastName = default, DateTime? lastUpdated = default, string monthlySalary = default, string phone = default, string state = default, EmployeeStatus? status = default, Guid tenantId = default, DateTime? updatedAt = default, Guid? userId = default, string weeklyHours = default, string zip = default)
        {
