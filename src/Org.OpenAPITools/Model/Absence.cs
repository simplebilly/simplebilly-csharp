...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Absence : IValidatableObject
    {
        ...
        public Absence(AbsenceType? absenceType = default, DateTime? approvedAt = default, Guid? approvedBy = default, DateTime createdAt = default, DateTime? deletedAt = default, Guid employeeId = default, DateOnly endDate = default, Guid id = default, string notes = default, DateOnly startDate = default, AbsenceStatus? status = default, Guid tenantId = default, DateTime? updatedAt = default)
        {
