...
namespace Org.OpenAPITools.Model
{
    ...
    /// TimeEntryClockIn
    /// </summary>
    [DataContract(Name = "TimeEntryClockIn")]
    public partial class TimeEntryClockIn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeEntryClockIn" /> class.
        /// </summary>
        /// <param name="notes">notes.</param>
        public TimeEntryClockIn(string notes = default)
        {
            this.Notes = notes;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimeEntryClockIn {\n");
