...
namespace Org.OpenAPITools.Model
{
    ...
    /// PosRegisterCreate
    /// </summary>
    [DataContract(Name = "PosRegisterCreate")]
    public partial class PosRegisterCreate : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PosRegisterCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PosRegisterCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PosRegisterCreate" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="status">status.</param>
        public PosRegisterCreate(string name = default, PosRegisterStatus? status = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PosRegisterCreate and cannot be null");
            }
            this.Name = name;
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PosRegisterCreate {\n");
