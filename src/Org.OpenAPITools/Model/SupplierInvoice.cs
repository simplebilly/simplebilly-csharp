...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SupplierInvoice : IValidatableObject
    {
        ...
        /// <param name="lineItems">JSON array of &#x60;{product_id, name, quantity, unitPriceNet, taxRate}&#x60;. (required).</param>
        /// <param name="notes">notes.</param>
        /// <param name="purchaseOrderId">References the purchase order entity..</param>
        /// <param name="status">One of: draft | matched | has_variances | posted | cancelled (required).</param>
