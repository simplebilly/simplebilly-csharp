# Org.OpenAPITools.Model.KycRecordCreate
...
**KycDate** | **DateOnly** | Datum der KYC-Prüfung (GwG § 8). | [optional] 
**Notes** | **string** | Freitext-Notizen. | [optional] 
**RetentionUntil** | **DateOnly** | Aufbewahrungsfrist (GwG § 8 Abs. 4: 5 Jahre). | [optional] 
